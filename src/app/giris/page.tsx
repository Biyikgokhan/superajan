      ...
      >
        <div className="text-center">
          ...
          <p className="mt-3 text-sm text-muted">
            Google hesabınızla hızlıca başlayın.
          </p>
        </div>
        ...
        >
          ...
          <button
            ...
            className="flex h-14 w-full items-center justify-center gap-3 rounded-full border border-border bg-surface text-sm font-medium text-accent transition-all hover:border-accent hover:bg-surface-hover disabled:opacity-50"
          >
            {googleLoading ? (
              <motion.div
                animate={{ rotate: 360 }}
